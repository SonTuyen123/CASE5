...
const Modals = () => {
  const [bacgroud, setBackgoud] = useState(
    " hidden py-12 bg-gray-700 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0"
  );
  const handleClick = () => {
    setBackgoud(
  ...
  console.log(bacgroud);

  return (
    <div>
    
      <div aria-hidden="false">
        <div className={bacgroud} id="modal">
          <div
            role="alert"
