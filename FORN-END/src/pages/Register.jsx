...
import { verifyRegister } from "../redux/features/verifySlice";
...
export default function Register() {
  ...
  const register = async (data) => {
    return await axios.post("http://localhost:8080/admin/register", data);
  };
    ...
    <div>
      <div className="p-28 w-screen h-screen mx-auto overflow-hidden bg-gray-100 shadow-lg md:flex md:h-full">
        <div className="grid w-full grid-cols-3">
          ...
          >
            <div className="pt-2 font-serif text-3xl font-bold text-left text-black my-18">
              Âm nhạc không chỉ để nghe. Âm nhạc còn là music !
            </div>
