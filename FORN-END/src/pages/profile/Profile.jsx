...
const Profile = () =>{
  ...
  <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
    <div className="p-4 md:p-12 text-center lg:text-left">
      ...
      <h1 className="text-3xl font-bold pt-8 lg:pt-0">{user && user.username}</h1>
      <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25" />
      <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><svg className="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" /></svg> Còn thiếu </p>
      <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">

      <i class="fa-regular fa-envelope  text-green-700 ">&nbsp; &nbsp; &nbsp;{user && user.email}</i>

      </p>
      <p className="pt-8 text-sm">Trong văn hóa Việt Nam, chúng ta hầu như không sử dụng “tôi”. Sử dụng “mình” (tôi) và “bạn” (bạn) nếu bạn gặp ai đó có thể bằng tuổi. Trong trường hợp bạn đã biết tuổi của người kia, hãy sử dụng: “Em”, “cháu”, “chị”, “cô”, “dì”,… Sau đó, cho biết tuổi của bạn để cả hai chọn đại từ phù hợp để giao tiếp.

      Ví dụ 1: Chào bạn! Mình tên là Ana. Năm nay mình 20 tuổi.

      Ví dụ 2: Bạn có thể gọi mình là Ana. Mình năm nay đã trải qua 20 mùa xuân.</p>
  ...
  <div className="w-full lg:w-2/5">
    ...
    <img src={user.image} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
    {/* Image from: http://unsplash.com/photos/MP0IUfwrn0A */}
  </div>
  {/* Pin to top right corner */}
  <div className="absolute top-0 right-0 h-12 w-18 p-4">
    <button className="fa-solid fa-house-chimney fa-2xl primary-color-icons" onClick={handleGoHome} ></button>
  </div>
</div>
